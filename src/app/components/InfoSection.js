    ...
    >
      <div className="flex min-h-screen flex-col md:flex-row items-center justify-center w-full text-black gap-20 lg:gap-50">
        <div className="flex flex-col items-center ">
          <h1 className="text-[90px] mb-5 font-[Allura]">
            {t("locationTitle")}
          </h1>
          <h1 className="text-2xl mb-3">Continental Club</h1>
          <h1 className="text-sm mb-4">London, Westminster, United Kingdom</h1>
          <a
            ...
            className="border border-[1.5px] rouded text-sm px-3 py-1 rounded-sm mb-8 cursor-pointer duration-105 hover:scale-105"
          >
            Google Maps
          </a>
        </div>
        <div className="w-80 md:w-100 lg:w-170 text-center">
